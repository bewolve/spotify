...
export const PopularSongs = async () => {
  ...
  const data = await axiosInstance
    .get(
      "/recommendations?limit=20&market=PK&seed_artists=2oSONSC9zQ4UonDKnLqksx,5r3wPya2PpeTTsXsGhQU8O,4PULA4EFzYTrxYvOVlwpiQ,5HcunTidTUrOaf8V0iJcvl,3uHUKCspaCzAab9A3LlGAr",
      {
        headers: {
